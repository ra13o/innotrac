...
class AutonomousControlUnit(Node):
    ...
    def lifter_status_callback(self, msg):
        ...
        # Call send_nscmd2 with the appropriate lifter height
        if lifter_name == 'front':
            self.send_nscmd2(front_height=self.target_lifter_height)
        elif lifter_name == 'middle':
            self.send_nscmd2(middle_height=self.target_lifter_height)
        elif lifter_name == 'rear':
            self.send_nscmd2(rear_height=self.target_lifter_height)
